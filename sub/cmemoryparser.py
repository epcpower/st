...
class StructMember:
    ...
    #
    #     parent = self
    #     while isinstance(parent, type(self)):
    #         names[0:0] = parent.name
    #         parent = parent.parent
    #
    #     offset = parent.offset_of(names)
    #
    #     return address

    def unpack(self, bits):
        self.value = base_type(self).unpack(bits)
        return self.value
...
class Variable:
    ...
    def unpack(self, data):
        self.value = base_type(self).unpack(data)
        return self.value
