...
def main(sys_argv):
    ...
    status_bits = Flags(model=d.epc_control, point='Evt1')
    fault_bits = Flags(model=d.epc_control, point='FaultFlags')
    warning_bits = Flags(model=d.epc_control, point='WrnFlgs')
